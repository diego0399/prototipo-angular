                    ...
                    <tr class="sw-row">
                      ...
                      <td>
                        @if (s.codigoSoftware; as cod) {
                          <select class="control" [disabled]="c.estado === 'Completada' || s.estado !== 'Realizado'"
...
<<<<<<< HEAD
  ...
  // ---------- Software F0302: agrupado por categoría, «Seleccionar todo» y versión del catálogo ----------
  /** Categorías presentes en el software del proceso, en el orden en que aparecen. */
  ...
  protected itemsCategoria(c: ConfiguracionF0302, categoria: string): SoftwareF0302[] {
    return c.software.filter((s) => (s.categoria || 'Otros') === categoria);
  }
